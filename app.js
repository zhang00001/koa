...
const List = mongoose.model('list', new mongoose.Schema({ title: String, thumbnailsUrl: String, price: Number, score: String, gifUrl: String }));
...
app
    ...
    .use(fileStatic(`${__dirname}/www`))
    .use((views(__dirname + '/template', {
    map: {
        html: 'swig'
    }
})))
